...
<center><a href="teacherData.php"><button class="button" >Teacher Information</button></a></center>
...
<center><a href="notice.php"><button class="button" >Notice Board</button></a></center>
